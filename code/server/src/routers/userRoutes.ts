...
import { checkBirthDateValidator } from "../validators/userValidator"
...
class UserRoutes {
    ...
    initRoutes() {
        ...
        this.router.get(
            "/:username",
            (req: any, res: any, next: any) => {
                this.authService.isLoggedIn(req, res, next)
            },
